...
function sessions = sortSessionsDD(tData, monk, drug, precision)
...
for ii = 1:length(tData)
    ...
    [existingParams,existingIdx] = multipleIsMember(curPrf,curDc,curDuration,...
        curFreq,curVoltage,curMonk,curFoci,curDrug,...
        prf,dc,duration,freq,voltage,monkS,foci,drugS);
