...
if nargin < 5
    theta = [0,0];
    szImg = [ceil(2*xDist/res(1)+size(ind,1)),ceil(2*yDist/res(2))+size(ind,2),size(ind,3)];
...
% First Fiducial
fid1 = [(center(1)-xDist*cos(theta(1))),center(2)-sin(theta(1))*xDist,center(3)];
...
% Second Fiducial
fid2 = [center(1)+xDist*cos(theta(1))-yDist*sin(theta(1)),center(2)+yDist*cos(theta(1))+xDist*sin(theta(1)),center(3)];
...
% Third Fiducial
fid3 = [center(1)+xDist*cos(theta(1))+yDist*sin(theta(1)),center(2)-yDist*cos(theta(1))+xDist*sin(theta(1)),center(3)];
