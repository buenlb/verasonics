...
if NA*2048 > 524288
    error('rowsPerFrame value may result in restrictions - see manual and make sure you know what you are doing!')
end
Resource.RcvBuffer(1).rowsPerFrame = NA*2048; % this allows for 1/4 maximum range
...
for n = 2:NA
    Receive(n) = Receive(1);
    Receive(n).acqNum = n;
    Receive(n).startDepth = (n-1)*250+1;
    Receive(n).endDepth = 2*250;
end
