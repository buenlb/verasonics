...
nCycles = 15; % number of cycles with which to excite Tx (can integer multiples of 1/2)
...
Process(1).method = 'plotAndCloseVSX_afterMeetingCondition';
...
SeqControl(3).condition = 'syncSYNC_CLK';
