...
% non-zero may be useful.
TX(2).Origin = [0,0,0]; 
TX(2).focus = r/lambda; % The radius of the transducer. r is defined in setupVerasonicsStruct
TX(2).steer = [0*pi/180,25*pi/180];
...
Event(2).tx = 2; % use 1st TX structure.
...
save C:\Users\Taylor\Documents\Projects\MonkeyTx\setupTransmit.mat
